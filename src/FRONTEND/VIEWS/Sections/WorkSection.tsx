    ...
    return (
        <div className="prt_work_page h-screen prt_section" id={PRT_WORK_PAGE_SECTION}>
            ...
            <div className="prt_work_title grid grid-cols-12">
                <h5 className="prt_pf_content_i col-start-3 col-span-3">a cou<span>pl</span>e of things <span>I</span>&#39;ve wor<span>k</span>ed on</h5>
            ...
            <div className="prt_project_section grid grid-cols-12">
                <div className="prt_prev_button col-start-1 col-span-1 flex justify-center">
                ...
                <div className="prt_next_button col-start-12 col-span-1 flex justify-center" >
