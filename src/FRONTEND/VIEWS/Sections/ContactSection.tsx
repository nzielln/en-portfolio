    ...
    return (
        <div className="prt_contact_page h-screen prt_section flex flex-col justify-center" id={PRT_CONTACT_PAGE_SECTION}>
            ...
            <div
                ...
                <div className="prt_contact_links md:col-start-7 md:col-span-2 lg:col-start-9 lg:col-span-2 xl:col-start-10 xl:col-span-3 flex flex-col justify-end md:mt-0 md:mb-0 mt-12 mb-28 md:pb-14 md:text-left text-right ">
