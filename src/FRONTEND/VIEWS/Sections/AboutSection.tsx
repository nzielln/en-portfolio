...
const AboutSection = () => {
    return (
        <div className="prt_about_page h-screen prt_section grid grid-rows-2 items-center" id={PRT_ABOUT_PAGE_SECTION}>
            <div className="prt_about_me grid grid-cols-12 md:gap-2 lg:gap-4 xl:gap-6">
            ...
            <div className="prt_about_tech grid grid-cols-12 md:gap-2 lg:gap-4 xl:gap-6 items">
