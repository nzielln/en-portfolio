    ...
    return (
        <div className="prt_about_page h-screen prt_section grid grid-rows-2" id={PRT_ABOUT_PAGE_SECTION}>
            <div className="prt_about_me grid grid-cols-12">
                <h4 className="prt_about_me_title prt_pf_content_i prt_lowercase text-right col-start-7 col-span-2">A <span>littl</span>e b<span>it</span> a<span>b</span>ou<span>t</span> me</h4>
            ...
            <div className="prt_about_tech grid grid-cols-12 items">
                <h4 className="prt_about_me_title prt_pf_content_i prt_lowercase col-start-6 col-span-1"><span>T</span>ec<span>h</span>no<span>l</span>ogies <span className="prt_uppercase">I</span> wor<span>k</span> w<span>it</span>h</h4>
